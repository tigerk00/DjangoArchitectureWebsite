...
from .models import News, NewsShot, NewsFile
...
class NewsShotInline(admin.TabularInline):
    model = NewsShot
    extra = 0
...
class NewsAdmin(admin.ModelAdmin):
    ...
    view_on_site = False
    list_display = ("title","url", "draft", "important")
    list_filter = ("date","draft", "important")
    search_fields = ("title",)
    inlines = [NewsShotInline, NewsFileInline]
    save_on_top = True
    save_as = True
    list_editable = ("draft",)
    readonly_fields = ("get_image",)
